...
# Habit Completion Model (to track habit completion)
class HabitCompletion(db.Model):
    ...
    user = db.relationship('User', backref=db.backref('habit_completions', lazy=True))

    def __repr__(self):
        return f'<HabitCompletion habit_id={self.habit_id} user_id={self.user_id} completed_at={self.completed_at}>'

# Habit Reminder Model (for setting reminders)
