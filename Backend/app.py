...
app.config['MAIL_USERNAME'] = os.getenv('MAIL_USERNAME')  # Email username (use environment variable)
app.config['MAIL_PASSWORD'] = os.getenv('MAIL_PASSWORD')  # Email password (use environment variable)
